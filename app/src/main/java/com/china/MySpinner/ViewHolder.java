...
public class ViewHolder {
    ...
    private ViewHolder(Context context, ViewGroup parent, int layoutId,
        ...
        this.mViews = new SparseArray<View>();  // 相当于 HashMap
    ...
    public static ViewHolder getNo(Context context, View convertView,
                                   ViewGroup parent, int layoutId, int position) {
     ...
     * @return
     */
    public static ViewHolder getNoRe(Context context, View convertView,
                                     ViewGroup parent, int layoutId, int position) {
        ViewHolder holder = new ViewHolder(context, parent, layoutId, position);
        return holder;
    }
    ...
    public ViewHolder setRadioButtonText(int viewId, String text, String tag) {
        RadioButton view = getView(viewId);
        view.setTag(tag);
        view.setText(text);
        return this;
